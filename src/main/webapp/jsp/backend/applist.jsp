...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form method="post" action="applist" id="form1">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="datatable-responsive"
                                ...
                                <tbody>
                                <c:forEach var="appInfo" items="${noPassAppinfo.list }" varStatus="status">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="dataTables_info" id="datatable-responsive_info"
                                 role="status" aria-live="polite">共${noPassAppinfo.total }条记录
                                ${noPassAppinfo.pageNum }/${noPassAppinfo.pages }页
                            </div>
                        </div>
                        <div class="col-sm-7">
                            <div class="dataTables_paginate paging_simple_numbers"
                                ...
                                <div>
                                    ...
                                    <a href="javascript:go(${noPassAppinfo.prePage==0?1:noPassAppinfo.prePage})">上一页</a>
                                    <a href="javascript:go(${noPassAppinfo.nextPage==0?noPassAppinfo.pages:noPassAppinfo.nextPage})">下一页</a>
                                    <a href="javascript:go(${noPassAppinfo.pages})">尾页</a>
                                </div>
                            </div>
                        </div>
                    </div>
