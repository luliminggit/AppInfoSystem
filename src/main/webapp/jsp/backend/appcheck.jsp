    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content1">
                <form class="form-horizontal form-label-left" action="checksave?appid=${appInfo.id}" method="post">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control col-md-7 col-xs-12"
                                   value="${appInfo.cname1} --> ${appInfo.cname2} --> ${appInfo.cname3}"
                                   readonly="readonly">
                        </div>
                    </div>
                    <div class="item form-group">
            ...
            <div class="x_content" style="display: block;">
                ...
                <form class="form-horizontal form-label-left">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="number" value="${oneAppVersion.versionsize }"
                    ...
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="select">发布状态 <span
                                class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="publishStatus" id="publishStatus" value="${oneAppVersion.publishStatusName }" readonly="readonly">
                        </div>
                    </div>
