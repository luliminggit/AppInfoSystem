        ...
        <div class="x_panel">
            ...
            <div class="x_content1">
                ...
                <div class="x_content" style="display: block;">
                    <br>
                    <form class="form-horizontal form-label-left"  enctype="multipart/form-data" action="/addAppVersion" method="post"
                         >
                        <input type="hidden" name="appid" value="${appid}">
                        <input type="hidden" name="modifydate" id="shijian" value="" >
