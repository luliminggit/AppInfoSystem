                ...
                <form class="form-horizontal form-label-left" action="/updateappinfo" method="post"
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <select name="categorylevel1" id="queryCategoryLevel5" class="form-control"
                                    required="required">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <select name="categorylevel2" id="queryCategoryLevel6" class="form-control"
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <select name="categorylevel3" id="queryCategoryLevel7" class="form-control"
                                    required="required">
              ...
              <textarea id="appInfo" name="appinfo" required="required"
                  ...
                  ${appInfo.appinfo}</textarea>
                     ...
                     <%--   <label class="control-label col-md-3 col-sm-3 col-xs-12">
                       ...
                       <%-- <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div id="uploadfile" style="display: none">
                                <input id="attach"  type="file" class="form-control col-md-7 col-xs-12" name="attach" value="">
                    ...
                    <div class="item form-group">
                       ...
                       <img height="50" width="50" src="/${appInfo.logopicpath}"/>
                        <div class="col-md-6 col-sm-6 col-xs-12">
...
<%--<script src="${pageContext.request.contextPath }/statics/localjs/.js"></script>--%>
<script language="JavaScript">
    ...
    $(function () {
        ...
        $.post("getOneCategroy", null, function (data) {
            ...
            $("#queryCategoryLevel5").val(${appInfo.categorylevel1})
            Level2();
        }, "json");
        //发送异步请求加载二级分类
        function Level2() {
            ...
            $.post("showCategoryLevel2", {"tid": tid}, function (data) {
                ...
                $("#queryCategoryLevel6").val(${appInfo.categorylevel2})
                Level3()
        ...
        function Level3() {
            ...
            $("#queryCategoryLevel7").val(${appInfo.categorylevel3})
        }
